...
- GTA V launches with memory-safe RAGE flags (`-maxStreamedGrid 10 -minStreamedGrid 5 -hdr 0 -percentvidmem 100`) auto-completed at startup and merged into `commandline.txt` beside the game exe, preventing the city-driving OOM freeze/crash; flags the user already set always win.
